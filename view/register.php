...
<body>
    ...
    <div class = "ui middle aligned center aligned grid">
        <div class = "column">
            <form class = "ui large form" method = "POST" action = "register_2.php" name = "frmLogin">
                <div class = "ui stacked segment">
                    ...
                    <div class = "form__info">
                        <p>註冊表示您同意<a href = "https://user.gamer.com.tw/help/detail.php?sn = 294" class = "blue">會員規範</a>及<a href = "https://user.gamer.com.tw/help/detail.php?sn = 144" class = "blue">隱私權政策</a>。</p>
                    </div>
                    <input type = "submit" name = "regester" class = "huge ui blue button" value = "註冊" style = "width: 100%;">
                    <br>
                    <br>
                </div>
            </form>
